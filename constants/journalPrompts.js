...
export const morningPrompts = [
  ...
  {
    num: 'II · Meet',
    q: 'Who will I meet today that I find difficult, and what do I owe them anyway?',
    hint: "Marcus began his mornings by naming who he would meet: the meddling, the ungrateful, the arrogant. He was not being pessimistic. He was refusing to be surprised. Then he added the part that matters, that none of them can implicate him in ugliness, and that he cannot be angry with his own kin.\n\nJustice is one of the four cardinal Virtues, and the Stoics meant something demanding by it. Oikeiōsis, the widening of concern outward, holds that the circle beginning with you extends to your household, your city, and finally every rational being. What you owe a person does not depend on how they treat you.\n\nThat is the whole force of anyway. The difficult person is still owed your patience, your honesty, the work you promised. Naming them before the day begins is what lets you meet them as a person rather than as an interruption.\n\nIf no one difficult is coming, answer it plainly. Name whoever has a claim on you today, and what it is.",
  },
  {
    num: 'III · Name',
    q: 'What am I postponing that matters? Name one thing.',
    hint: "Seneca opened On the Shortness of Life with a charge: it is not that we have a short time to live, but that we waste much of it. We are experts at deferring what matters in favor of what is urgent, easy, or comfortable.\n\nThe Stoics were deeply aware of mortality as a clarifying force. If you knew today was your last, what would you regret not having done? That regret is information. It points at what actually matters to you beneath the noise of daily preference.\n\nPostponement is rarely a problem of scheduling. It is usually a failure of nerve, which is why courage is the Virtue this question exercises. Naming the thing is the first courageous act available to you today.\n\nNaming one thing — just one — makes it real. The act of naming is the act of committing. Not to completing it today necessarily, but to acknowledging that it exists and that you are responsible for it.",
  },
  {
    num: 'IV · Foresee',
    q: 'What might come at me today that I cannot control, and how would a person of Virtue bear it?',
    hint: "This is premeditatio malorum: the premeditation of adversity. The Stoics practiced it daily, rehearsing the difficulties of the day before it began.\n\nNotice what this asks that the earlier questions did not. II and III asked what is yours to do: who you owe, and what you keep putting off. This one asks what may be done to you. The plan that collapses at noon, the delay, the news you did not ask for. Epictetus reduced the whole practice to two words, bear and forbear, and this is the bearing half.\n\nModern research confirms what the Stoics intuited: mentally simulating obstacles before they occur reduces anxiety and improves performance. It works because the obstacle loses its power to surprise you. You've already met it, already chosen your response.\n\nAsk not 'what bad thing might happen' in a fearful way, but 'how would a person who embodies wisdom, courage, and justice bear this?' You're not predicting disaster. You're rehearsing Virtue.",
  },
  {
    num: 'V · Question',
    q: 'What am I already telling myself about today, and is it true?',
