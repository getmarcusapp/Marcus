...
export const STOICS = [
  ...
  },
  {
    ...
    teaching: 'Feelings are not weather. They follow from judgments you have made, which means they can be examined, and corrected.',
  ...
  },
  {
    ...
    teaching: 'Philosophy is not something you know. It is something you practice, in what you eat, what you wear, and what you are willing to go without.',
  ...
  },
  {
    ...
    life: "Cicero belonged to the skeptical Academy and argued with the Stoics all his life, which did not stop him from becoming their most important transmitter. On Duties, written in a few months in 44 BC while Rome came apart, adapts the lost work of the Stoic Panaetius and became one of the most read books in Europe for the next sixteen centuries.\n\nHe was proscribed and killed the following year. Much of what we know about Stoic ethics, and about the arguments the school could not win, comes from a man who was reporting the other side's position in order to examine it.",
    teaching: 'What is honorable and what is advantageous are not two questions. Treating them as two is how people talk themselves into things.',
