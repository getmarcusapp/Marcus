...
const s = StyleSheet.create({
  ...
  body: { padding: spacing.md, paddingTop: spacing.lg, backgroundColor: colors.lightBg },
  textCard: {
    borderWidth: 0.5, borderColor: colors.lightBorder, borderRadius: radius.lg,
    padding: 22, marginBottom: 14, backgroundColor: colors.lightWhite,
  },
  bodyText: { fontSize: 17, color: colors.lightText2, lineHeight: 28 },
  editTrigger: {
    borderWidth: 0.5, borderColor: colors.lightBorder2, borderRadius: radius.md,
    padding: 16, alignItems: 'center', marginBottom: 28,
  },
  editTriggerText: { fontSize: 13, color: colors.lightMuted, letterSpacing: 1, textTransform: 'uppercase' },
  editInput: {
    borderWidth: 0.5, borderColor: colors.lightBorder2, borderRadius: radius.lg,
    padding: 18, fontSize: 16, color: colors.lightText, lineHeight: 26,
    minHeight: 240, textAlignVertical: 'top', marginBottom: 12,
    backgroundColor: colors.lightWhite,
  },
  editBtns: { flexDirection: 'row', gap: 10, marginBottom: 28 },
  editBtn: {
    flex: 1, borderWidth: 0.5, borderColor: colors.lightBorder,
    borderRadius: radius.md, padding: 16, alignItems: 'center',
  },
  editBtnSave: { borderColor: colors.lightBorder2, backgroundColor: colors.lightBg3 },
  editBtnText: { fontSize: 13, color: colors.lightMuted, letterSpacing: 0.8, textTransform: 'uppercase' },
  secLabel: { fontSize: font.labelSize, letterSpacing: font.sectionTracking, color: colors.lightDim, textTransform: 'uppercase', marginBottom: 14 },
  virtueCard: {
    borderWidth: 0.5, borderColor: colors.lightBorder, borderRadius: radius.lg,
  ...
  virtueName: { fontSize: 22, fontWeight: '400', color: colors.lightText },
  virtueLatin: { fontSize: 13, color: colors.lightMuted },
  virtueDesc: { fontSize: 15, color: colors.lightText2, lineHeight: 24 },
  virtueDivider: { height: 0.5, backgroundColor: colors.lightBorder, marginVertical: 14 },
  virtueQuestion: { fontSize: 14, color: colors.lightMuted, lineHeight: 22 },
});