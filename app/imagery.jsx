...
const s = StyleSheet.create({
  ...
  sectionSub: { fontSize: 14, color: colors.textSecondary, lineHeight: 21 },
  ...
  virtueQuote: { fontSize: 16, color: colors.textPrimary, fontFamily: font.bodyLightItalic, fontStyle: 'italic', lineHeight: 22, marginBottom: 6 },
  virtueQuoteAttr: { fontSize: 11, color: colors.textSecondary, letterSpacing: 1, fontFamily: font.bodyMedium, textTransform: 'uppercase' },
  virtueArtLabel: { fontSize: font.labelSize, letterSpacing: 2, color: colors.textSecondary, fontFamily: font.bodyMedium, textTransform: 'uppercase', marginBottom: 8 },

  footerNote: {
    borderWidth: 0.5, borderColor: colors.border, borderRadius: radius.md,
    padding: 18, marginTop: 22, marginBottom: 12, backgroundColor: colors.bgElevated,
  },
  footerNoteText: { fontSize: 13, color: colors.textSecondary, lineHeight: 21, fontFamily: font.body },
});
