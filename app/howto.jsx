...
const sections = [
  ...
  },
  {
    ...
    content: 'The Stoics had a name for the discipline of attention: prosochē. Epictetus gave it an entire discourse. It is sometimes called Stoic mindfulness, though the aim is not calm. It is vigilance: catching what you have already agreed to before it hardens into a judgment.\n\nThe pause is one question, held for a breath or two, and then you return to your day. There is no timer, nothing to finish, and nothing to keep score of. The question changes each time you open it.\n\nFind it on the Practice tab under Mid-day. If you want to be asked rather than remember, turn on the mid-day reminder in Settings → Notifications and choose your hour. It is off by default, because attention you choose is the point of the practice.\n\nIt does not count toward your streak. Like the meditations, it is a tool and not a requirement.',
  },
  {
...
const s = StyleSheet.create({
  ...
  sectionBlockOpen: { borderColor: colors.border },
  sectionHeader: {
  ...
  footerQuote: { fontSize: 14, color: colors.textSecondary, fontStyle: 'italic', fontFamily: font.bodyLightItalic, textAlign: 'center', lineHeight: 22, marginBottom: 8 },
  footerAttr: { fontSize: 11, color: colors.textSecondary, letterSpacing: 1, fontFamily: font.bodyMedium, textTransform: 'uppercase' },
});