...
const s = StyleSheet.create({
  ...
  timingBtnSub: { fontSize: 12, color: colors.textDim, fontStyle: 'italic', lineHeight: 18 },
  ...
  distortionSub: { fontSize: 13, color: colors.textMuted, marginBottom: 14, fontStyle: 'italic' },
  ...
  distortionQ: { fontSize: 13, color: colors.textMuted, lineHeight: 20, fontStyle: 'italic' },
  ...
  histTiming: { fontSize: 10, color: colors.textDim, letterSpacing: 0.5, fontStyle: 'italic' },
  ...
  histResponse: { fontSize: 14, color: colors.textMuted, marginTop: 8, fontStyle: 'italic', fontFamily: font.serif, lineHeight: 22 },
