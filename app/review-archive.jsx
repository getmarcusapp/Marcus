...
const s = StyleSheet.create({
  ...
  filterCount: { fontSize: 12, color: colors.textSecondary, paddingHorizontal: 16, paddingBottom: 8 },
  ...
  emptyText: { fontSize: 15, color: colors.textSecondary, lineHeight: 24, textAlign: 'center', maxWidth: 360 },
  emptyCta: { marginTop: 28, borderWidth: 0.5, borderColor: colors.accentDim, borderRadius: radius.md, paddingVertical: 14, paddingHorizontal: 22, backgroundColor: colors.bg },
  ...
  histStreak: { fontSize: 11, color: colors.textSecondary, letterSpacing: 0.5, marginTop: 2 },
  ...
  histBest: { fontSize: 14, color: colors.accent, marginBottom: 4 },
  histWorst: { fontSize: 14, color: colors.accentDim, marginBottom: 4 },
  histPreview: { fontSize: 14, color: colors.textSecondary, fontStyle: 'italic', marginTop: 6, lineHeight: 22 },
