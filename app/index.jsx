...
const s = StyleSheet.create({
  ...
  skullIcon: { width: 80, height: 80, marginBottom: 20, opacity: 0.9 },
  ...
  quoteText: { fontSize: 17, color: colors.textSecondary, lineHeight: 30, fontFamily: font.serif },
  quoteAttr: { fontSize: 10, color: colors.textMuted, marginTop: 12, letterSpacing: 1.5 },
  ...
  tag: { borderWidth: 0.5, borderColor: colors.lightBorder, borderRadius: 5, paddingHorizontal: 9, paddingVertical: 3 },
  ...
  tagText: { fontSize: 9, color: colors.lightMuted, letterSpacing: 1, textTransform: 'uppercase' },
