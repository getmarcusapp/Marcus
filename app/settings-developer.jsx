...
const s = StyleSheet.create({
  ...
  resetBtnText: { fontSize: 14, color: colors.textSecondary, letterSpacing: 0.5 },
  helperText: { fontSize: 12, color: colors.textSecondary, lineHeight: 18, marginTop: 6, marginHorizontal: 4 },
});
