...
const e = StyleSheet.create({
  ...
  promptQ: { fontSize: 14, color: colors.textSecondary, lineHeight: 22, fontStyle: 'italic', fontFamily: font.serif },
...
const s = StyleSheet.create({
  ...
  sub: { fontSize: font.subSize, color: colors.textMuted, marginTop: 8, fontStyle: 'italic', fontFamily: font.serif },
  ...
  mementoText: { fontSize: 16, color: colors.textSecondary, lineHeight: 26, fontStyle: 'italic', fontFamily: font.serif },
  ...
  virtueDetailText: { fontSize: 15, color: colors.textSecondary, lineHeight: 24, fontStyle: 'italic', fontFamily: font.serif },
  virtueDetailDivider: { height: 0.5, backgroundColor: colors.border, marginVertical: 14 },
  virtueDetailQuestion: { fontSize: 14, color: colors.textMuted, fontStyle: 'italic', fontFamily: font.serif, lineHeight: 22 },
  ...
  promptQ: { fontSize: font.bodySize, color: colors.textSecondary, lineHeight: 26, fontStyle: 'italic', fontFamily: font.serif },
  ...
  histAnswer: { fontSize: 15, color: colors.textSecondary, lineHeight: 24, fontStyle: 'italic', fontFamily: font.serif },
});