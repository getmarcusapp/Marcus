...
function build() {
  ...
  const html = '<!doctype html><html lang="en"><head>' +
    ...
    '<meta property="og:image" content="' + SITE + '/og/learn.png">' +
    '<meta name="twitter:card" content="summary_large_image">' +
    '<meta name="twitter:title" content="Learn Stoicism">' +
    '<meta name="twitter:description" content="' + esc(desc) + '">' +
    '<meta name="twitter:image" content="' + SITE + '/og/learn.png">' +
    ...
    '<a href="/">getmarcus.app</a> &middot; <a href="/learn">Learn</a> &middot; <a href="/about">About</a> &middot; ' +
